...
namespace MemoriaJaték
{
    public partial class Form1 : Form
    {
        ...
        {
            countDownTime--;
            lblTimeLeft.Text = "Ennyi időd maradt: " + countDownTime;
            if (countDownTime < 1)
            {
                GameOver("Lejárt az Időd, vesztettél :(");
        ...
        private void RestartGame()
        {
            ...
            tries = 0;
            lblStatus.Text = "Nem találat: " + tries + " db.";
            lblTimeLeft.Text = "Ennyi időd maradt: " + totalTime;
            gameOver = false;
            GameTimer.Start();
        ...
        private void GameOver(string msg)
        {
            GameTimer.Stop();
            gameOver = true;
            MessageBox.Show(msg + " Újrakezdéshez kattints a gombra.");
        }
